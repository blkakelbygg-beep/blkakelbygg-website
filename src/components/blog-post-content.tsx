...
import { blogPostPath, type BlogPost } from "@/lib/blog-posts";
...
/**
 * Shared rendering for a single blog post — used both by the standard
 * /blogg/[slug] route and by posts published at their own dedicated
 * top-level URL (via BlogPost.href).
 */
export function BlogPostContent({ post, otherPosts }: { post: BlogPost; otherPosts: BlogPost[] }) {
